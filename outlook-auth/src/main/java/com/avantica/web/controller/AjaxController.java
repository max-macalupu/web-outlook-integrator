...
public class AjaxController {
	...
	public void rolControlador() throws Exception {
		users.toString();
	}
	...
	private void iniDataForTesting() {
		...
		User user1 = new User("max", "pass123", "max@yahoo.com", "012-1234567", "address 123");
		User user2 = new User("paolo", "pass456", "paolo@yahoo.com", "016-7654321", "address 456");
		User user3 = new User("diego", "pass789", "diego@yahoo.com", "012-111111", "address 789");
		users.add(user1);
		users.add(user2);
		users.add(user3);
